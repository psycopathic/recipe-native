...
import { registerSchema, type RegisterInput, loginSchema, type LoginInput } from "./auth.schema.js";
import { comparePasswords, hashPassword } from "../../utils/hash.js";
import { createRefreshToken, createAccessToken } from "../../utils/token.js";

export const registerUserService = async (body: RegisterInput) => {
...
export const loginUserService = async (body: LoginInput) =>{
